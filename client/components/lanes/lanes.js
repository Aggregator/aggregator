...
export default class Lanes extends Component {
  render () {
    return (
      <div className='section-lanes' id='lanes'>
        <div className='row'>
              ...
              <div className='col s3'>
                <Card>
                  <CardHeader title='DEV' subtitle='version: v1.0.13'>
                    <AlertError color={red700} className='alert' />
                  </CardHeader>
              ...
              <div className='col s3'>
                <Card>
                  <CardHeader title='TEST' subtitle='version: v1.0.1'>
                    <AlertWarning color={yellow700} className='alert' />
                  </CardHeader>
              ...
              <div className='col s3'>
                <Card>
                  <CardHeader title='DEMO' subtitle='version: v1.0.0'>
                    <ActionDone color={green700} className='alert' />
                  </CardHeader>
